...
bool CGLData::Load( char* filename )
{
	if ( filename != NULL)
	{
		if ( m_pModel != NULL )
...
//////////////////////////////////////////////////////////////////////////
int CGLData::LoadSMD( char* path, smd_model* pModel )
{
	FILE* pfile;
	char cmd[1024];
	int option;
...
//		- int (Error message, result of the function)
//////////////////////////////////////////////////////////////////////////
int CGLData::AddNode( char* input, smd_model* pModel )
{
	int index;
	int parent;
	char name[64];
...
//		- int (Error message, result of the function)
//////////////////////////////////////////////////////////////////////////
int CGLData::AddBone( char* input, smd_model* pModel )
{
	int index;
	vec3_f pos, rot;
	smd_bone* pbone;
...
//////////////////////////////////////////////////////////////////////////
smd_mesh* CGLData::GetMesh( char* texture, smd_model* pModel )
{
...
//		- char* (Striped string)
//////////////////////////////////////////////////////////////////////////
char* CGLData::StripString( char* str )
{
	char* res;
